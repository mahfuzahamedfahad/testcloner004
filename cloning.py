...
try:
    ...
    os.system('python2 khancloning.py')
...
\033[1;91m☞ Auther     : TEAMKHAN

\033[1;92m☞ Facebook page : https://www.facebook.com/KhanWhiteHatHackersTeam/
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update TEAM KHAN Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' TEAM KHAN FACEBOOK Group')

	print (S + '[' + Y + '☞4' + S + ']' + G + ' Log O
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://github.com/mahfuzahamedfahad')
	    ...
	    psb('Facebook groupe : https://www.facebook.com/groups/khanhackerteam/?ref=share"✓')

	    psb('WellCome To TEAMKHAN')

	    psb('Congratulations TEAMKHAN Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ khan✓')

	    psb('🔓Password ☆ lover✓')

	    psb('join our groupe https://www.facebook.com/groups/khanhackerteam/?ref=share ✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/TEAM_KHAN && python2 khancloning.py')
